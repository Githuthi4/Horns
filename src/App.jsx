...
function App() {
  ...
  const loadCartCount = useCallback(async () => {
    try {
      const cartRes = await api.cart.get(sessionId);
  ...
  for (let index = 0; index < products.length; index += cardsPerView) {
    bestSellerPages.push(products.slice(index, index + cardsPerView));
  }
          ...
          <div className="discount-section">
            <div className="discount-products-card">
              ...
              {discountPages.length > 0 ? (
                  ...
                  >
                    {discountPages.map((group, groupIndex) => (
                      <div key={`discount-page-${groupIndex}`} className="discount-products-list">
                        {group.map((product) => (
                          <article key={product.id} className="discount-product">
                            ...
                            <div className="discount-product-copy">
                              ...
                              <div className="discount-product-prices">
                                ...
                                <button
                                  ...
                                  aria-label={`Add ${product.name} to cart`}
                                >
                                  <span className="discount-price-default">{formatPrice(product.price)}</span>
                ...
                <p className="text-neutral-400 p-4">No sale products available</p>
              )}
            </div>
